 ...
 * EvenlyDiscretizedFunction, and XySequence. XySequence is generally
...
class SequenceBenchmark {
	...
	private static final double[] XS = new double[] { 0.0010, 0.0013, 0.0016, 0.0019, 0.0022, 0.0025, 0.0028, 0.0031 };

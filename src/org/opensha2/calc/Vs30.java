...
/**
 * Identifiers for commonly used values of Vs30. These correspond to the NEHERP site classes
 * that have histroically been supported by the NSHMp in hazard calculations.
 *
 * @author Peter Powers
 */
public enum Vs30 {

...
class ImmutableXySequence extends XySequence {
	...
	ImmutableXySequence(XySequence sequence, boolean clear) {
		 ...
		 * y-values when copying, however, in practice, it is only ever used
		 * when creating mutable covariants.
		 * 
		 * The covariant cast below is safe as all implementations descend from
		 * this class.
		 */

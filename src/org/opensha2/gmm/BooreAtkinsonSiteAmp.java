...
class BooreAtkinsonSiteAmp {
	...
	/*
	 * NOTE: Currently only 2 Gmms use this model. One object is created for
	 * every period instance. Should the model be more broadly used, consider
	 * adding a loading cache.
	 * 

 ...
 * to keep reimplementing the same function bodies.<p>
 *
 ...
 *
 * The basic functions this abstract class implements are:<br> <ul> <li>get, set
 * Name() <li>get, set, Info() <li>get, set, Tolerance() <li>equals() - returns
 * true if all three fields have the same values. </ul>
 *
...
implements DiscretizedFunc {
   ...
   * the real x-value is used. Note that the tolerance must be smaller than 1/2
   * the delta between data points for evenly discretized function, no
  ...
  //
  // Element points =
  // xml.addElement(AbstractDiscretizedFunc.XML_METADATA_POINTS_NAME);
  // for (int i=0; i<this.getNum(); i++) {
  // Element point =
  // points.addElement(AbstractDiscretizedFunc.XML_METADATA_POINT_NAME);
  ...
  //
  // Element points =
  // funcElem.element(AbstractDiscretizedFunc.XML_METADATA_POINTS_NAME);
  ...
  // public static void writeSimpleFuncFile(DiscretizedFunc func, String
  // fileName) throws IOException {
  // writeSimpleFuncFile(func, new File(fileName));
  // }
  //
  // public static void writeSimpleFuncFile(DiscretizedFunc func, File
  ...
  // public static ArbitrarilyDiscretizedFunc loadFuncFromSimpleFile(String
  ...
  // }
  //
  // public static ArbitrarilyDiscretizedFunc
  // loadFuncFromSimpleFile(InputStream is) throws FileNotFoundException,
  // IOException {

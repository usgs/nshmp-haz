...
public class GriddedSubsetSurface extends ContainerSubset2D<Location> implements GriddedSurface {
	...
	/**
	 * Proxy method that returns the number of colums in the main
	 * GriddedSurface.
	 */
	...
	@Override public LocationList getEvenlyDiscritizedListOfLocsOnSurface() {
	...
	@Override public LocationList getEvenlyDiscritizedPerimeter() {
	...
	@Override public double getAveGridSpacing() {
		return parentSurface.getAveGridSpacing();
	}

	@Override public LocationList getEvenlyDiscritizedUpperEdge() {
		return getRow(0);
	}

	@Override public LocationList getEvenlyDiscritizedLowerEdge() {
		return getRow(getNumRows() - 1);
	}

	@Override public Location getFirstLocOnUpperEdge() {
		return get(0, 0);
	}

	@Override public Location getLastLocOnUpperEdge() {

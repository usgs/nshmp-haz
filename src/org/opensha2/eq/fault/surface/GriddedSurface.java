...
public interface GriddedSurface extends Container2D<Location>, RuptureSurface {
   ...
   * the implementing class. Don't assume the locations are ordered as one reads
   * the words on a page in a book (not the case for CompoundGriddedSurface).
   */
   ...
   * class. These locations should be ordered along the fault following the Aki
   * and Richards convention. TODO move to Container2D topRow()
   */
   ...
   * edge of the surface. Further details are specified by the implementing
   * class. These locations should be ordered along the fault following the Aki
   * and Richards convention. TODO move to Container2D bottomRow()
   */
   ...
   * not necessarily equally spaced). This may be the original Fault Trace used
   * to define the surface, but not necessarily.
   */

...
public abstract class YoungsEtAl_1997 implements GroundMotionModel {
  ...
  private static final double calcMean(final Coefficients c, final Coefficients cPGA,
      final SiteAmp siteAmp, final boolean slab, final GmmInput in) {
   ...
   * vs30 other than the internal rock reference of 760. Atkinson & Macias (2009),
   * which also relied on this implementation now points to the published
   * implementation in the Boore & Atkinson (2008) GMM [BA_08].
   */
  private static class SiteAmp {

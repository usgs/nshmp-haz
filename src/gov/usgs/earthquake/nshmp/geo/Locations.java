...
import static gov.usgs.earthquake.nshmp.geo.Coordinates.degreesLatPerKm;
import static gov.usgs.earthquake.nshmp.geo.Coordinates.degreesLonPerKm;
...
public final class Locations {
   ...
   * be noice to add methods such as translate(vector) or distanceTo(loc) to
   ...
   * contains operations using a {@code Location}s native (radian-based) storage
   * of latitude and longitude. It is also constrained to minimum and maximum

...
public final class Parsing {
   ...
   *         or if weights do not sum to 1.0, within
   *         {@link Data#WEIGHT_TOLERANCE}
   * @throws NumberFormatException if supplied string does not contain parseable
   *         {@code double} values
   ...
   * {@code [6.5 :: [1.0 : 0.8, 5.0 : 0.2]; 10.0 :: [1.0 : 0.2, 5.0 : 0.8]]} to
   * a {@code NavigableMap<Double, Map<Double, Double>}. The returned map and
   * nested maps are immutable and should only be accessed via
  ...
  /**
   * Convert an ordered list of non-repeating {@code Integer}s to a more compact
